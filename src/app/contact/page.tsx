                    ...
                    <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-start lg:justify-center lg:gap-16">
                        ...
                        <div className="flex-shrink-0">
                            <ProfileCard
                                ...
                                status="Ideator"
                                contactText="Contact Me"
                                avatarUrl="/hemsagar.png"
                                showUserInfo
                                enableTilt={true}
                                enableMobileTilt
                                onContactClick={() => {
                                    window.open("mailto:hemsagarbc1@gmail.com");
                                }}
                                behindGlowColor="rgba(255, 150, 100, 0.67)"
                                behindGlowEnabled
                                innerGradient="linear-gradient(145deg,#6e49498c 0%,#ff717144 100%)"
                            />
                        </div>
                        ...
                        <div className="w-full max-w-sm space-y-6">
                            <div>
                                ...
                                <h2 className="text-2xl font-bold">Hemsagar B C</h2>
                                <p className="text-muted-foreground mt-1">
                                    Ideator — BIT Connect
                                </p>
                                <p className="text-sm text-muted-foreground">
                            ...
                            <div className="space-y-3">
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="text-xs text-muted-foreground">Phone</p>
                                        <p className="text-sm font-medium">+91 72046 14795</p>
                                    </div>
                                </a>

                                <a
                                    href="mailto:hemsagarbc1@gmail.com"
                                    className="flex items-center gap-3 rounded-lg border px-4 py-3 transition-colors hover:bg-accent"
                                >
                                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary/10">
                                        <Mail className="h-4 w-4 text-primary" />
                                    ...
                                    <div>
                                        <p className="text-xs text-muted-foreground">Email</p>
                                        <p className="text-sm font-medium">hemsagarbc1@gmail.com</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-3">
                                    <Button variant="outline" size="icon" className="h-11 w-11" asChild>
                                        <a
                                            href="https://www.linkedin.com/in/hemsagar-b-c-b2610a318/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            aria-label="LinkedIn"
                                        >
                                    ...
                                    <Button variant="outline" size="icon" className="h-11 w-11" asChild>
                                        <a
                                            href="https://github.com/Hemsagar-BC"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            aria-label="GitHub"
                                        >
